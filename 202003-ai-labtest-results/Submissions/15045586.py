# -*- coding: utf-8 -*-
"""
Created on Fri Jul 10 16:05:32 2020
...
for k in range(3, 101):
    if k % 2 == 1:
        ...
        column = glass['attributes'].columns.tolist()

        x_train = glass['train']['attributes'][column]
        y_train = glass['train']['target']
        knc.fit(x_train, y_train)

        x_test = glass['test']['attributes'][column]
