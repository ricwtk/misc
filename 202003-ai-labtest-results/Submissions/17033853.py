...
for k in range(3, 101):
    if k % 2 == 1:
        ...
        classification['k'].append(k)
        classification['accuracy'].append(knc.score(x_test, y_test))
...
plt.scatter(classification['k'], classification['accuracy'])
plt.xlabel('k')
plt.ylabel('Accuracy')
