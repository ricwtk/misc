...
x_train, x_test, y_train, y_test = train_test_split(data.iloc[:, 1:9], y, test_size=0.3, random_state=1)
...
for index, k in enumerate(k_values):
    ...
    print(f'k value: {k}')
    print(f'Testing Data Accuracy: {knc.score(x_test, y_test):.4f}')
    print("")


pt.figure()
pt.plot(k_values, accuracies)
pt.title('Prediction Accuracy at value of k')
pt.xlabel('k')
pt.ylabel('accuracy')
